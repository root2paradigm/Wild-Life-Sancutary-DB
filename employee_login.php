    ...
    <?php
      ...
      if (isset($_POST['login_submit'])) {
        ...
        else
        {
          ...
          $query = mysql_query("SELECT * FROM `employee` WHERE EID = '$username' AND PASSWORD ='$password'", $connection);
          echo "SELECT * FROM `employee` WHERE EID = '$username' AND PASSWORD ='$password'";
