    ...
    <?php
      ...
      if (isset($_POST['login_submit'])) {
        ...
        else
        {
          ...
          $query = mysql_query("SELECT * FROM `veterinarian` WHERE VID = '$username' AND Password ='$password'", $connection);
          echo "SELECT * FROM `veterinarian` WHERE VID = '$username' AND Password ='$password'";
